...
void next_object(FILE *json, node *pNode)
{
  ...
  while (c != '}')
  {
    ...
    if (strcmp(name, "type") == 0)
    {
      ...
      if (strcmp(pNode->type, "camera") != 0 && strcmp(pNode->type, "plane") != 0 && strcmp(pNode->type, "sphere") != 0)
      {
    ...
    else if ((strcmp(name, "color") == 0) || (strcmp(name, "position") == 0) || (strcmp(name, "normal") == 0))
    {
      skip_ws(json);
      expect_c(json, ':');
      skip_ws(json);
